...
export const rightSvgInfo = [
  ...
  {
    d: "M0 123L314.772 123C322.154 123 329.393 120.957 335.686 117.097L414.257 68.9032C420.55 65.0431 427.788 63 435.171 63L759 63",
    stops: [
      <stop
        key={1}
        offset="0"
  ...
  {
    d: "M-4.93638e-06 189L283.251 189C290.648 189 297.9 191.051 304.202 194.925L382.513 243.075C388.814 246.949 396.066 249 403.463 249L759 249",
    stops: [
      <stop
        key={1}
        offset="0"
    ...
    <article className="flex w-full flex-col items-center justify-center gap-16 border-0 border-solid px-1 pt-2 md:px-16 lg:pt-8 overflow-hidden">
      <div className="relative flex h-fit w-full flex-row items-start justify-center gap-0">
        ...
        >
          ...
          <h5 className="max-w-[450px] text-center text-gray-400">
            Million Lint is a IDE extension that helps you identify and fix slow React components{" "}
            <i>(public beta)</i>
          </h5>
          ...
          <button
            className="flex flex-row items-center py-2 mx-2 gap-x-2 rounded-md group bg-stone-200 p-4"
            onClick={handleClickWizard}
          >
            <p className="text-sm text-zinc-900 dark:text-zinc-400 font-mono">
